...
public class MainActivity extends ActivityGroup implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		 ...
		 * /** 给底部工具栏绑定监听器
		 */
		LinearLayout tabBar = (LinearLayout) findViewById(R.id.tab_bar);// 该布局上存在四个text控件
		int count = tabBar.getChildCount();// 获取该布局上控件的个数
	...
	/**
	 * 为ViewPager设置Adapter即PagerAdapter
	 * 
	 * @author 刘立洲
	 * 
	 */
